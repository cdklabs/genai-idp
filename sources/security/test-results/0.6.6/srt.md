...
- **CI-visible findings:** 12009
- **Source:** live scan results (`.srt/issues.json`) — 291 git-ignored finding(s) excluded to match the CI view
...
|----------|----------|---------:|-----:|
| Bandit | Python SAST | 11669 | 54 |
| Checkov | IaC / CloudFormation misconfig | 182 | 2 |
| Semgrep | multi-language SAST | 105 | 1 |
...
|----------|------:|------:|------:|------:|------:|
| HIGH | 0 | 0 | 60 | 44 | 104 |
| MEDIUM | 55 | 0 | 47 | 0 | 102 |
| LOW | 11443 | 3 | 347 | 0 | 11793 |
| INFO | 10 | 0 | 0 | 0 | 10 |
