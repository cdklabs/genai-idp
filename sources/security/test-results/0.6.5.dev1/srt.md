...
- **CI-visible findings:** 10585
- **Source:** live scan results (`.srt/issues.json`) — 6646 git-ignored finding(s) excluded to match the CI view
...
|----------|----------|---------:|-----:|
| Bandit | Python SAST | 10274 | 54 |
| Checkov | IaC / CloudFormation misconfig | 155 | 2 |
| Semgrep | multi-language SAST | 106 | 1 |
| security-matrix | AWS security-control review (SRT rules) | 50 | 44 |
...
|----------|------:|------:|------:|------:|------:|
| HIGH | 0 | 2 | 58 | 41 | 101 |
| MEDIUM | 103 | 0 | 0 | 0 | 103 |
| LOW | 10372 | 0 | 0 | 0 | 10372 |
| INFO | 9 | 0 | 0 | 0 | 9 |
...
| Semgrep | `package_managers.npm.npm-missing-minimum-release-age.npm-missing-minimum-release-age` | 0 | 1 | 0 | 0 |
...
| security-matrix | `DDB-002` | 0 | 0 | 1 | 18 |
