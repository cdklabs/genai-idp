...
class SampleCode extends Component {
    private readonly appProject: AwsCdkTypeScriptWorkspaceApp;

    constructor(
        project: AwsCdkTypeScriptWorkspaceApp,
...
export interface AwsCdkTypeScriptWorkspaceAppOptions
    extends TypeScriptWorkspaceOptions,
 ...
 * @pjid awscdk-app-ts
 */
export class AwsCdkTypeScriptWorkspaceApp extends TypeScriptWorkspaceAppProject {
    /**
    ...
    constructor(options: AwsCdkTypeScriptWorkspaceAppOptions) {
        super({
            ...options,
            sampleCode: false,
            bundlerOptions: {
