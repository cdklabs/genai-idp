...
import type { aws_codeguruprofiler, aws_ec2, aws_iam, aws_kms, aws_lambda, aws_logs, aws_sns, aws_sqs, Duration, RemovalPolicy, Size } from 'aws-cdk-lib';

/**
 * Options for a Python Lambda function
 */
export interface IdpPythonFunctionOptions {
  /**
